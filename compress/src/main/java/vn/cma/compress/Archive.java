...
public class Archive {
     ...
     * @param level                 @see {@link vn.cma.compress.utils.Constants }
     * @param dictionary            @see {@link vn.cma.compress.utils.Constants }
    ...
    public ArchiveData getArchiveItemsList(String filePath, String password) {
        ...
        return new ArchiveData(
                result == 0 ? archiveItemsList.getItems() : new ArrayList<ArchiveItemsList.ArchiveItem>(),
                result == 8888
        );
    }
